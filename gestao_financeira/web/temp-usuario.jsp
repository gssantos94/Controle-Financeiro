...
<%
  ArrayList<Usuario> lista_usuario = (ArrayList<Usuario>) request.getAttribute("usuario");
%>
<!DOCTYPE html>
<html lang="pt-br">
  <head>
    <jsp:include page="header.html"/>
    <title>Form: Usuários</title>
    <script>
  ...
  <body>
      ...
      <section class="container">
        ...
        <div class="row">
          <div class="col-md-2 text-center">
            <form method="post" action ="cria_usuario" class="form-temporario p-md-0">
              ...
              <div class="form-temporario mb-2">
                ...
                <input type="text" class="form-control mb-2" placeholder="Suspenso" required name="suspensoC">
              </div>
              <button class="btn mb-2 btn-lg btn-primary" type="submit">Criar</button>
            </form>
          </div>
          <div class="col-md-2 text-center">
            <form method="post" action="edita_usuario" class=" form-temporario p-4 p-md-0">
              ...
              <div class="form-temporario mb-2">
                ...
                <input type="text" class="form-control mb-2" placeholder="Suspenso" value="${suspenso}" required name="suspensoE">
              </div>
              ...
              <tbody>
                <%
                  for (int i = 0; i < lista_usuario.size(); i++) {
                    Usuario aux = lista_usuario.get(i);
                %>
                <tr>
                  <td><%=aux.getId()%></td>
                  <td><%=aux.getNome()%></td>
                  ...
                  <td>
                    <a class="btn" href="get_usuario?id=<%= aux.getId()%>"><i class=" far fa-edit"></i></a>
                    <a class="btn" href="javascript: apaga_usuario(<%= aux.getId()%>)"><i class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>
                <% }%>
              </tbody>
    ...
    <script type="text/javascript">
      ...
      function apaga_usuario(id) {
        let resposta = confirm('Deseja apagar este usuário?');
        if (resposta === true) {
          window.location.href = "apaga_usuario?id=" + id;
        }
      }
    </script>
  </body>
